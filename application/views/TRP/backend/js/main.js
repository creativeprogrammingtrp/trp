...
var webApp = function() {
    ...
    var uiInit = function () {
        ...
        pageContent.css('min-height', '0px');
   ...
   var primaryNav = function () {
        var menuLinks = $('ul.sub-menu > li > a');
        menuLinks.click(function(ev) {       
            $('#primary-nav .sub-menu').not($(this).parents('.sub-menu')).slideUp(250); 
...
function setupMenu(){
	...
	if($('#page-container').hasClass('Settings')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-setting').addClass('active');	
	}
	if($('#page-container').hasClass('Content')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-content').addClass('active');	
	}
	if($('#page-container').hasClass('Benefits')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-benefits').addClass('active');	
	}
	if($('#page-container').hasClass('Orders')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-orders').addClass('active');	
	}
	if($('#page-container').hasClass('Reporting')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-reporting').addClass('active');	
	}
	if($('#page-container').hasClass('Ero')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-accounts, #menu-ero').addClass('active');	
	}
	
	if($('#page-container').hasClass('Admin')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-accounts, #menu-ero').addClass('active');	
	}
	if($('#page-container').hasClass('Service')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-accounts,#menu-service').addClass('active');	
	}
	if($('#page-container').hasClass('Training')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-training').addClass('active');	
	}
	if($('#page-container').hasClass('Bank') || $('#page-container').hasClass('Loans')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-banking,.menu-banking').addClass('active');	
	}
	if($('#page-container').hasClass('BankProducts')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-bank-product').addClass('active');	
	}
	
	if($('#page-container').hasClass('Services')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-services').addClass('active');	
	}
	
	if($('#page-container').hasClass('Customers')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-customers').addClass('active');	
	}
	
	if($('#page-container').hasClass('Insurance')){
		$('#primary-nav li a').removeClass('active');
		//alert('Insurance');
		$('#menu-insurance').addClass('active');	
	}
	
	if($('#page-container').hasClass('Benifits')){
		$('#primary-nav li a').removeClass('active');
		
		$('#menu-benifits').addClass('active');	
	}
	
	if($('#page-container').hasClass('clientCenter')){
		$('#primary-nav li a').removeClass('active');
