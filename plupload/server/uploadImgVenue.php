...
$url_dataImg = '../../data/venues/';       
while (is_file($targetDir.$file_id.'.'.$ext) || is_file($targetDir.$file_id.'.jpg') || isset($_SESSION["file_upload"][$file_id]) || is_file($url_dataImg.$file_id.'.'.$ext)) {
	$file_id = md5($fileName + rand()*100000);
}
