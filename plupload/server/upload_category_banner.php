...
// Settings
$targetDir = '../../resource/catbanner';
$ext_path = "";
if (isset($_REQUEST['cat_id']))
{
	$targetDir = $targetDir.'/'.$_REQUEST['cat_id'];
	$ext_path = $_REQUEST['cat_id'].'/';
}
...
if(is_file($targetDir . DIRECTORY_SEPARATOR . $fileName)){
	$result = array('success'=>true, 'file_id'=>$file_id, 'width'=>$width, 'height'=>$height, 'ext'=>$ext, 'error'=>'','path'=>'resource/catbanner/'.$ext_path.$file_id.'.'.$ext);
}else{
